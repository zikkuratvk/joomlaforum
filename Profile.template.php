...
<div id="profileview" class="flow_auto">
	...
	echo '
			...
			<span id="userstatus">', $context['can_send_pm'] ? '<a href="' . $context['member']['online']['href'] . '" title="' . $context['member']['online']['label'] . '" rel="nofollow">' : '', $settings['use_image_buttons'] ? '<!--<i class="fa fa-user-circle' . ($message['member']['online']['is_online'] ? '-o' : '') . '" aria-hidden="true" ></i>-->' : $context['member']['online']['text'], $context['can_send_pm'] ? '</a>' : '', $settings['use_image_buttons'] ? '<span class="smalltext"> ' . $context['member']['online']['text'] . '</span>' : '';
